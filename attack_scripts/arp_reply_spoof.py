#t!/usr/bin/python
"""
Conduct an ARP reply spoof. This is done by sending 
(unrequested) ARP reply packets to the victim claiming that 
you have an IP address that you do not.

Usage: python arp_reply_spoof.py -v <IP1> -r <IP2>
